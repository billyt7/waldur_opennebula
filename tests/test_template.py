...
from waldur_opennebula.tests.utils import override_plugin_settings
...
class TemplatePullTest(test.APITransactionTestCase):
    def setUp(self):
        ...
        self.settings = factories.OpenNebulaServiceSettingsFactory()
        self.backend = backend.OpenNebulaBackend(self.settings)
        self.patcher = mock.patch('waldur_opennebula.backend.OpenNebulaClient')
