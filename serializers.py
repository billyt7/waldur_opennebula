...
class ServiceSerializer(
    ...
    SERVICE_ACCOUNT_FIELDS = {
        'backend_url': _('OpenNebula auth URL'),
        'username': _('OpenNebula user username'),
        'password': _('OpenNebula user password'),
    }

    SERVICE_ACCOUNT_EXTRA_FIELDS = {
        'default_cluster_label': _(
            'Label of OpenNebula cluster that will be used for virtual machines provisioning'
        ),
...
class ServiceProjectLinkSerializer(
    ...
    class Meta(structure_serializers.BaseServiceProjectLinkSerializer.Meta):
        ...
        extra_kwargs = {
            'service': {'lookup_field': 'uuid', 'view_name': 'opennebula-detail'},
        }
...
class NestedPortSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            'url': {'lookup_field': 'uuid', 'view_name': 'opennebula-port-detail'},
            'network': {'lookup_field': 'uuid', 'view_name': 'opennebula-network-detail'},
        }
...
class NestedDiskSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            'url': {'lookup_field': 'uuid', 'view_name': 'opennebula-disk-detail'},
        }
...
class VirtualMachineSerializer(structure_serializers.BaseResourceSerializer):
    service = serializers.HyperlinkedRelatedField(
        ...
        view_name='opennebula-detail',
        read_only=True,
        lookup_field='uuid',
    )

    service_project_link = serializers.HyperlinkedRelatedField(
        view_name='opennebula-spl-detail',
        queryset=models.OpenNebulaServiceProjectLink.objects.all(),
        allow_null=True,
        required=False,
    )
    ...
    template = serializers.HyperlinkedRelatedField(
        view_name='opennebula-template-detail',
        lookup_field='uuid',
    ...
    cluster = serializers.HyperlinkedRelatedField(
        view_name='opennebula-cluster-detail',
        lookup_field='uuid',
    ...
    datastore = serializers.HyperlinkedRelatedField(
        view_name='opennebula-datastore-detail',
        lookup_field='uuid',
    ...
    folder = serializers.HyperlinkedRelatedField(
        view_name='opennebula-folder-detail',
        lookup_field='uuid',
...
class PortSerializer(structure_serializers.BaseResourceSerializer):
    ...
    service_project_link = serializers.HyperlinkedRelatedField(
        view_name='opennebula-spl-detail', read_only=True,
    )
    ...
    class Meta(structure_serializers.BaseResourceSerializer.Meta):
        ...
        # Virtual Ethernet adapter name is generated automatically by OpenNebula itself,
        ...
        extra_kwargs = dict(
            vm={'view_name': 'opennebula-virtual-machine-detail', 'lookup_field': 'uuid',},
            network={'view_name': 'opennebula-network-detail', 'lookup_field': 'uuid',},
            **structure_serializers.BaseResourceSerializer.Meta.extra_kwargs
        )
...
class DiskSerializer(structure_serializers.BaseResourceSerializer):
    ...
    class Meta(structure_serializers.BaseResourceSerializer.Meta):
        ...
        # Virtual disk name is generated automatically by OpenNebula itself,
        # therefore it's not editable by user
        read_only_fields = (
            structure_serializers.BaseResourceSerializer.Meta.read_only_fields
            + ('name', 'vm',)
